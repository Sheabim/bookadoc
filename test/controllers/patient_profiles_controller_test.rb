...
class PatientProfilesControllerTest < ActionController::TestCase
  ...
  test "should create patient_profile" do
    assert_difference('PatientProfile.count') do
      post :create, patient_profile: { address: @patient_profile.address, country: @patient_profile.country, first_name: @patient_profile.first_name, last_name: @patient_profile.last_name, latitude: @patient_profile.latitude, longitute: @patient_profile.longitute, medicare_number: @patient_profile.medicare_number, phone: @patient_profile.phone, postcode: @patient_profile.postcode, state: @patient_profile.state, suburb: @patient_profile.suburb, user_id: @patient_profile.user_id }
    end
  ...
  test "should update patient_profile" do
    patch :update, id: @patient_profile, patient_profile: { address: @patient_profile.address, country: @patient_profile.country, first_name: @patient_profile.first_name, last_name: @patient_profile.last_name, latitude: @patient_profile.latitude, longitute: @patient_profile.longitute, medicare_number: @patient_profile.medicare_number, phone: @patient_profile.phone, postcode: @patient_profile.postcode, state: @patient_profile.state, suburb: @patient_profile.suburb, user_id: @patient_profile.user_id }
    assert_redirected_to patient_profile_path(assigns(:patient_profile))
  end
