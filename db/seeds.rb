...
DoctorProfile.create(user_id: user2.id,title: 'Dr', first_name: 'Rafael', last_name: 'arruda')

 user3 = User.create(user_type: 'doctor', email: 'doctor3@test.com', password: '12345678')
DoctorProfile.create(user_id: user3.id,title: 'Dr', first_name: 'Guy', last_name: 'Gilead')

user4 = User.create(user_type: 'doctor', email: 'doctor4@test.com', password: '12345678')
DoctorProfile.create(user_id: user4.id, title: 'Dr', first_name: 'Rachel', last_name: 'costa')
